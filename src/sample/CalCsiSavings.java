...
public class CalCsiSavings {
    ...
    public static void csi(Stage primaryStage) {
        ...
        fd.setOnAction(event -> {Stage stage = (Stage) close.getScene().getWindow(); stage.close(); CalCsiFD.csi(primaryStage);});
        ...
        simpleInt.setOnAction(event -> {Stage stage = (Stage) close.getScene().getWindow(); stage.close(); CalSimpleInterest.savings(primaryStage);});
        ...
        loans.setOnAction(event -> {Stage stage = (Stage) close.getScene().getWindow(); stage.close(); CalLoans.loans(primaryStage);});
        ...
        mortgage.setOnAction(event -> {Stage stage = (Stage) close.getScene().getWindow(); stage.close(); CalMortgage.mortgage(primaryStage);});
...
//Creating the Buttons and The Labels Required for the first grid pane.
        ...
        Label lbl4 = new Label(" Contribution");
...
//Initialising the buttons and text fields to the first grid pane.
        ...
        gridPane1.add(lbl4,0,5);
        gridPane1.add(txt4,1,5);
...
//Creating the labels and texts required for the third grid pane.
        Label lblCsi = new Label(" Results of the Compound Interest Savings with Contribution Calculator.");
...
//Initialising the labels and the texts to the third grid pane.
        ...
        primaryStage.setTitle("Compound Interest For Contribution Savings Calculator");
        primaryStage.show();
        ...
        buttonCal.setOnAction( e-> {
            ...
            try{
                if (txt.getText().isEmpty()){
                    ...
                    double monthlyPay = Double.parseDouble(myString4.trim());

                    double principleAmt = (accAmt - (monthlyPay*((Math.pow(1+(intRate/100/12),12*noOfYrs))-1)/(intRate/100/12)))/((Math.pow(1 + (intRate/12/100),12*noOfYrs)));
                    principleAmt = Math.round(principleAmt);

                    txt.setText(Double.toString(principleAmt));
                    txtInvested.setText("Rs. "+Double.toString(principleAmt));
                    txtInt.setText(myString2+"%");
                    txtYears.setText(myString1);
                    txtMonthlyPay.setText("Rs. "+monthlyPay);
                    txtTotal.setText("Rs. "+myString3);
                }
                    ...
                    double noOfYrs = (Math.log(((accAmt*(intRate/100))+(monthlyPay*12))/((principleAmt*(intRate/100))+(monthlyPay*12))))/(12*(Math.log(1+(intRate/100/12))));
                    noOfYrs = Math.round(noOfYrs);

                    txt1.setText(Double.toString(noOfYrs));
                    txtInvested.setText("Rs. "+principleAmt);
                    txtInt.setText(myString2+"%");
                    ...
                    double accAmt1 = (principleAmt*(Math.pow(1 + (intRate/12/100),12*noOfYrs)));
                    double accAmt2 = ((monthlyPay*((Math.pow(1+(intRate/100/12),12*noOfYrs))-1)/(intRate/100/12)));
                    double accAmt = accAmt1 + accAmt2;
                    accAmt = Math.round(accAmt);

                    txt3.setText("Rs."+Double.toString(accAmt));
                    txtInvested.setText("Rs. "+myString);
                    txtInt.setText(myString2+"%");
                    txtYears.setText(myString1);
                    txtMonthlyPay.setText("Rs. "+monthlyPay);
                    txtTotal.setText("Rs. "+Double.toString(accAmt));
                }
                    ...
                    double monthlyPay = ((accAmt-(principleAmt*(Math.pow(1 + (intRate/12/100),12*noOfYrs))))/(((Math.pow((1+(intRate/100/12)),12*noOfYrs)-1))/(intRate/100/12)));
                    monthlyPay = Math.round(monthlyPay);

                    txt4.setText("Rs."+Double.toString(monthlyPay));
                    txtInvested.setText("Rs. "+myString);
                    txtInt.setText(myString2+"%");
                    txtYears.setText(myString1);
                    txtMonthlyPay.setText("Rs. "+Double.toString(monthlyPay));
                    txtTotal.setText("Rs. "+accAmt);
                }
        ...
        button1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                }else if (txt4.isFocused()){
                    txt4.setText(txt4.getText()+buttonVal);
                }
            }
        });
        ...
        btnSave.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String save3 = txtTotal.getText();
                String save4 = txtMonthlyPay.getText();

                String result = "Invested Amount: Rs. "+save;
                String result1 = "Interest Rate is "+save1;
                String result2 = "Number of Years is "+save2;
                String result3 = "Total is Rs. "+save3;
                String result4 = "Monthly Payment is Rs. "+save4;
