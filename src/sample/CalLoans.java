...
public class CalLoans {
    public static void loans(Stage primaryStage) {
        Pane root = new Pane();

        Label lblHome = new Label("Loans");
...
//Creating the Buttons and The Labels Required for the first grid pane.
        Label lbl = new Label(" Loan Amount");
...
//Creating the labels and texts required for the third grid pane.
        Label lblLoans = new Label(" Results of the Loan Calculator.");
        lblLoans.setId("lblResult");
        Label lblInvested = new Label(" Loan Amount Received by the user : ");
...
//Initialising the labels and the texts to the third grid pane.
        gridPane3.add(lblLoans,0,1,2,1);
        ...
        btnSave.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String result = "Loan Amount: Rs. "+save;
